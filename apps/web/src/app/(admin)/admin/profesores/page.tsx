...
import { QuitarProfesorButton } from './quitar-profesor-button'
      ...
      {instructors.length === 0 ? (
        <div className="bg-white rounded-xl border border-stone-200 p-12 text-center">
          ...
          <p className="text-sm text-stone-400 mt-1">
            Usa el botón &quot;Invitar profesor&quot; para añadir uno.
          </p>
        </div>
      ) : (
          ...
          {instructors.map((instructor) => (
            <div key={instructor.id} className="bg-white rounded-xl border border-stone-200 p-5">
              <div className="flex items-start justify-between">
                ...
                <QuitarProfesorButton memberId={instructor.id} name={instructor.user.name} />
              </div>
